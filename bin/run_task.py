...
import sys
from vigiechiro.scripts import tadaridaD, tadaridaC, participation_generate_bilan


USAGE = 'usage : {} [d|c|bilan] [now|delay] <resource_id>'.format(sys.argv[0])


if __name__ == '__main__':
    logging.basicConfig(level=logging.INFO)
    if len(sys.argv) == 4 and sys.argv[1] in ['d', 'c', 'bilan'] and sys.argv[2] in ['now', 'delay']:
